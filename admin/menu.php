   ...
   <li>
             <a class="ai-icon" href="dosya-yukle.php" aria-expanded="false">
           ...
           <li>
             <a class="ai-icon" href="kategoriler" aria-expanded="false">
               <i class="far fa-newspaper"></i>
               <span class="nav-text">Döküman Kategorileri</span>
             </a>
           </li>
           <li>
             <a class="ai-icon" href="projeler" aria-expanded="false">
               <i class="far fa-newspaper"></i>
               <span class="nav-text">Dökümanlar</span>
             </a>
           </li>

           <li>
             <a class="ai-icon" href="egitimler" aria-expanded="false">
           ...
           <li>
             <a class="ai-icon" href="galeriler?do=files&id=3" aria-expanded="false">
               <i class="far fa-newspaper"></i>
