								...
								<div class="row">
									<div class="col-lg-12 mb-2">
										<div class="form-group">
											...
											<input type="text" name="strTitle" class="form-control" placeholder="Title" required="">
										</div> 
									</div>
								</div>
                            ...
                            <div class="card-body">   
								<div class="row">
									<div class="col-lg-12 mb-2">
										<div class="form-group">
											<label class="text-label">Title</label>
											<input type="text" name="strTitle" class="form-control" placeholder="Title" required="" value="<?php echo $row_info["strTitle"]; ?>">
										</div> 
									</div>
								</div>
								<div class="step-footer pull-right">
