													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Döküman Adı</label>
																<input type="text" name="proje_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Döküman Adı" required="">
															</div>
														</div>

														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Döküman Kısa Açıklama</label>
																<input type="text" name="proje_isveren[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Döküman Kısa Açıklama" required="">
															</div>
														</div>
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Döküman Adı</label>
																<input type="text" name="proje_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Döküman Adı" required="" value="<?php echo GetTableValue("proje_baslik",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Döküman Kısa Açıklama</label>
																<input type="text" name="proje_isveren[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Döküman Kısa Açıklama" required="" value="<?php echo GetTableValue("proje_yapilanis",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
