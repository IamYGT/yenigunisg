													...
													<div class="row">
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<input type="text" name="ekip_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="İsim Soyisim" required="">
															</div>
														</div>
													</div>
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> İsim Soyisim</label>
																<input type="text" name="ekip_baslik[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="İsim Soyisim" required="" value="<?php echo GetTableValue("ekip_baslik",TABLE,"where ekip_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
