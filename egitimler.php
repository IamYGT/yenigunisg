...
<html lang="tr">
<head>
<title>Eğitimlerimiz - Gaziantep Yenigün İş Sağlığı ve Güvenliği </title>
<?php include 'css.php'; ?>
</head>
<body>
  <?php include 'ust.php'; ?>
                            ...
                            <div class="services-two__inner">
                                ...
                                <div class="services-two__content-box">
                                    <div class="services-two__content">
                                        <h3 class="services-two__title"><a href="<?php echo $ayarlar["strURL"]; ?>/egitim/<?php echo $veri_listele["haber_seo"]; ?>"><?php echo 	$veri_listele["haber_baslik"]; ?></a></h3>
                                        <p class="services-two__text"><?php echo 	$veri_listele["haber_kisaaciklama"]; ?></p>
                                    </div>
                                    <div class="services-two__arrow">
                                         <a href="<?php echo $ayarlar["strURL"]; ?>/egitim/<?php echo $veri_listele["haber_seo"]; ?>"><span class="icon-next"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
